...
public class BitVectorSetCheckerOld extends SetMinimalityChecker<BitVectorSet> {
	 ...
	 * @return A {@code long[]} which contains the lowest 1-bit of {@code bitVector} as rightmost
