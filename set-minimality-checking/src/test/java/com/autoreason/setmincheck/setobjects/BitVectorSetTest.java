 ...
 *
 */
public class BitVectorSetTest implements Comparable<BitVectorSet> {
	 ...
	 */
	public BitVectorSetTest(long[] bv) {
		this.bitVector = bv;
		this.set = null;
	}
	 ...
	 */
	public BitVectorSetTest(Set<?> set) {
		this.set = set;
	 ...
	 */
	public BitVectorSetTest(Set<?> set, long[] bv) {
		this.set = set;
		this.bitVector = bv;
	}
